let create_rocket1 = document.querySelector('.create-rocket1');
let create_rocket2 = document.querySelector('.create-rocket2');

let accelerate_rocket1 = document.querySelector('.accelerate-rocket1');
let accelerate_rocket2 = document.querySelector('.accelerate-rocket2');

let brake_rocket1 = document.querySelector('.brake-rocket1');
let brake_rocket2 = document.querySelector('.brake-rocket2');

let print_rocket1 = document.querySelector('.print-rocket1');
let print_rocket2 = document.querySelector('.print-rocket2');

let print_all_rockets = document.querySelector('.print-all-rockets');
...
function goToBottom() {
    if(result) result.scrollTop = result.scrollHeight - result.clientHeight;
}
